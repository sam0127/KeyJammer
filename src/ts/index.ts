...
keyToNoteMap.set('KeyV', 'B1')

keyToNoteMap.set('KeyA', 'C2')
keyToNoteMap.set('KeyS', 'D2')
keyToNoteMap.set('KeyD', 'E2')
keyToNoteMap.set('KeyF', 'F2')

keyToNoteMap.set('KeyQ', 'G2')
keyToNoteMap.set('KeyW', 'A2')
keyToNoteMap.set('KeyE', 'B2')
keyToNoteMap.set('KeyR', 'C3')

//Right:
keyToNoteMap.set('KeyN', 'D3')
keyToNoteMap.set('KeyM', 'E3')
keyToNoteMap.set('Comma', 'F3')
keyToNoteMap.set('Period', 'G3')

keyToNoteMap.set('KeyJ', 'A3')
...
noteToFrequencyMap.set('C#7', 2217.46)
noteToFrequencyMap.set('D7', 2349.32)
noteToFrequencyMap.set('D#7', 2489.02)
noteToFrequencyMap.set('E7', 2637.02)
noteToFrequencyMap.set('F7', 2793.83)
noteToFrequencyMap.set('F#7', 2959.96)
noteToFrequencyMap.set('G7', 3135.96)
noteToFrequencyMap.set('G#7', 3322.44)
noteToFrequencyMap.set('A7', 3520.00)
noteToFrequencyMap.set('A#7', 3729.31)
noteToFrequencyMap.set('B7', 3951.07)
noteToFrequencyMap.set('C8', 4186.01)
